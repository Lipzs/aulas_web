...
public class MeuServlet extends HttpServlet {
  ...
  private void serveReq(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try (PrintWriter out = response.getWriter()) {
      out.println("<!DOCTYPE html>" + "<html>" + "<head>" + "<title>Manipulando formulários com Java Servlets</title>"
          + "</head>" + "<body>" + "<h1>Manipulando formulários com Java Servlets</h1>" + "<form method=\"post\">"
          + "<fieldset>" + "<legend>Novo Usuário</legend>" + "Nome: *<br/>"
          + "<input type=\"text\" name=\"nome\"/><br/>" + "E-mail: *<br/>"
          + "<input type=\"text\" name=\"email\"/><br/>" + "Senha: *<br/>"
          + "<input type=\"password\" name=\"senha\"/><br/>" + "Confirmar senha: *<br/>"
          + "<input type=\"password\" name=\"conf_senha\"/><br/>" + "Cidade:<br/>" + "<select name=\"cidade\">"
          + "<option value=\"-1\" selected>--Selecione</option>" + "<option value=\"1\">Florianópolis</option>"
          + "<option value=\"2\">São José</option>" + "<option value=\"99\">Outro</option>" + "</select><br/>"
          + "Idade:<br/>" + "<input type=\"text\" name=\"idade\"/><br/>" + "Comentários:<br/>"
          + "<textarea name=\"comentarios\" rows=\"4\"cols=\"30\"></textarea><br/>" + "Sexo:<br/>"
          + "<input type=\"radio\" name=\"sexo\" value=\"m\">,Masculino</input>"
          + "<input type=\"radio\" name=\"sexo\" value=\"f\">Feminino</input>"
          + "<input type=\"radio\" name=\"sexo\" value=\"o\">Outro</input></br>" + "<br/>"
          + "<input type=\"checkbox\" name=\"termos\"/> Concordo com os termos de uso *<br/>" + "<hr/>"
          + "<input type=\"submit\" value=\"Enviar\"/>" + "<input type=\"reset\" value=\"Limpar\"/>"
          + "* Campos obrigatórios" + "</fieldset>" + "</form>");
      ...
      if (request.getMethod().equals("POST")) {
        ...
        String confSenha = preProcessa(request.getParameter("conf_senha"));
        ...
        out.println("<h2>Dados Recebidos:</h2>" + "<ul>" + "<li><b>Nome:</b> " + nome + "</li>" + "<li><b>E-mail:</b> "
            + email + "</li>" + "<li><b>Senha:</b> " + senha + "</li>" + "<li><b>Confirmar senha:</b> " + confSenha
            + "</li>" + "<li><b>Cidade:</b> " + cidade + "</li>" + "<li><b>Idade:</b> " + idade + "</li>"
            + "<li><b>Comentários:</b> " + comentarios + "</li>" + "<li><b>Sexo:</b> " + sexo + "</li>"
            + "<li><b>Termos:</b> " + termos + "</li>" + "<ul>");
      }
